$(document).ready(function () {
  var DOMAIN = "http://localhost/inventory-management-php";
  $("#register_form").on("submit", function () {
    ...
    if (name.val() == "" || name.val().length < 6) {
      ...
      $("#u_error").html(
        "<span class='text-danger'>Please Enter Name and Name should be more than 6 char</span>"
      );
      status = false;
    } else {
    ...
    if (pass1.val() == "" || pass1.val().length < 9) {
      ...
      $("#p1_error").html(
        "<span class='text-danger'>Please Enter more than 9 digit password</span>"
      );
      status = false;
    } else {
